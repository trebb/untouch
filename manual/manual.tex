...
\section{Metronome/Drum Patterns}
...
\subsection[Split Point (Split Mode, 4Hands Mode)]{Split Point (Split Mode, 4Hands Mode)  --- \UiKey{\SET}D$\flat$3(A0--C8)}
\subsection[Two-Sound Dynamics/Pedal/Octave Shift]{Two-Sound Dynamics/Pedal/Octave Shift --- \UiKey{\SET}B$\flat$2}
...
\section[Store to Sound]{Store to Sound --- \UiKey{\II}\UiKey{\REG}}
\img {immediate_action.tex}
\section{Recorder}
\subsection[Store to Sound]{Current Song--- \UiKey{\REC} (record), \UiKey{\PL} (play)}
\img {songs.tex}
